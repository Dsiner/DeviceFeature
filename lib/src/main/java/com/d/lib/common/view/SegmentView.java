...
public class SegmentView extends View {
    ...
    private void initAttrs(Context context, AttributeSet attrs) {
        ...
        mTextSize = typedArray.getDimension(R.styleable.lib_pub_SegmentView_lib_pub_segmentv_textSize, ScreenUtils.dp2px(context, 14));
        mRectRadius = typedArray.getDimension(R.styleable.lib_pub_SegmentView_lib_pub_segmentv_radius, -1);
        mDivideWidth = typedArray.getDimension(R.styleable.lib_pub_SegmentView_lib_pub_segmentv_divideWidth, ScreenUtils.dp2px(context, 1));
        mPadding = typedArray.getDimension(R.styleable.lib_pub_SegmentView_lib_pub_segmentv_borderWidth, ScreenUtils.dp2px(context, 1));
        typedArray.recycle();
    }
    ...
    private void init(Context context) {
        ...
        // Get title height px
        mHeightText = (int) ScreenUtils.getTextHeight(mPaintB);
