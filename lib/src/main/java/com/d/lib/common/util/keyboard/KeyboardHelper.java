...
//        return inputManager.hideSoftInputFromWindow(view.getWindowToken(), 0);
    ...
    public static void setOnKeyboardEventListener(final Activity activity, final OnKeyboardEventListener listener) {
        ...
        final ViewTreeObserver.OnGlobalLayoutListener layoutListener = new ViewTreeObserver.OnGlobalLayoutListener() {
            ...
            private final int visibleThreshold = Math.round(ScreenUtils.dp2px(activity, KEYBOARD_VISIBLE_THRESHOLD_DP));
    ...
    public static boolean isKeyboardVisible(Activity activity) {
        ...
        int visibleThreshold = Math.round(ScreenUtils.dp2px(activity, KEYBOARD_VISIBLE_THRESHOLD_DP));
        activityRoot.getWindowVisibleDisplayFrame(r);
        int heightDiff = activityRoot.getRootView().getHeight() - r.height();
