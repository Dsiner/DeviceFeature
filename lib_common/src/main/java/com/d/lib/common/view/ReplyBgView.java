...
public class ReplyBgView extends View {
    ...
    private void initAttrs(Context context, AttributeSet attrs) {
        ...
        mRectRadius = typedArray.getDimension(R.styleable.lib_pub_ReplyBgView_lib_pub_replybv_radius, ScreenUtils.dp2px(context, 3));
        mOffset = typedArray.getDimension(R.styleable.lib_pub_ReplyBgView_lib_pub_replybv_offset, ScreenUtils.dp2px(context, 6.5f));
        mTrgHalfWidth = typedArray.getDimension(R.styleable.lib_pub_ReplyBgView_lib_pub_replybv_trgWidth, ScreenUtils.dp2px(context, 6)) / 2;
        mTrgHeight = typedArray.getDimension(R.styleable.lib_pub_ReplyBgView_lib_pub_replybv_trgHeight, ScreenUtils.dp2px(context, 5));
        typedArray.recycle();
    }
