...
public class ScrollTab extends HorizontalScrollView implements View.OnClickListener, ViewPager.OnPageChangeListener {
    ...
    private void initTypedArray(Context context, AttributeSet attrs) {
        ...
        mPadding = typedArray.getDimension(R.styleable.lib_pub_ScrollTab_lib_pub_stab_padding, ScreenUtils.dp2px(context, 12));
        ...
        mIndicatorWidth = typedArray.getDimension(R.styleable.lib_pub_ScrollTab_lib_pub_stab_indicatorWidth, ScreenUtils.dp2px(context, 30));
        mIndicatorWeight = typedArray.getDimension(R.styleable.lib_pub_ScrollTab_lib_pub_stab_indicatorWeight, ScreenUtils.dp2px(context, 1));
        mIndicatorRadius = typedArray.getDimension(R.styleable.lib_pub_ScrollTab_lib_pub_stab_indicatorRadius, ScreenUtils.dp2px(context, 0.5f));
        mIndicatorPadding = typedArray.getDimension(R.styleable.lib_pub_ScrollTab_lib_pub_stab_indicatorPadding, ScreenUtils.dp2px(context, 5));
        typedArray.recycle();
    }
