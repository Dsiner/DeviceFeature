...
public class ViewHelper {
    ...
    public static void autoSize(TextView textView, String text, float maxWidth, float dpMin, float dpMax) {
        ...
        final float minSize = ScreenUtils.dp2px(textView.getContext(), dpMin);
        float textSize = ScreenUtils.dp2px(textView.getContext(), dpMax);
        textView.setTextSize(TypedValue.COMPLEX_UNIT_PX, textSize);
        // Get the effective width of the current TextView
        final int availableWidth = ScreenUtils.dp2px(textView.getContext(), maxWidth);
